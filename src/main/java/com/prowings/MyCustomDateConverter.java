...
public class MyCustomDateConverter implements CustomConverter {
	...
	public Object convert(Object dest, Object source, Class<?> arg2, Class<?> arg3) {
		...
		if (source instanceof Account) {
			...
			// logic to convert epoch into Java Date - in string format
			...
			int cc = 0;
			return new Account(custAcc.getCustomerAccountNumber(), custAcc.getName(), custAcc.getIfscCode(), timestamp,
					cc);
		} else
			return null;
